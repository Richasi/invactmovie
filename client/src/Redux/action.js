...
export const getMoviesData = () => async (dispatch) => {
  ...
  try {
    let res = await axios.get(`https://invacbackend.onrender.com/movie`);
...
export const addMovie = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      `https://invacbackend.onrender.com/movie`,
      data
    );
...
export const updateMovieData = (id, data) => async (dispatch) => {
  ...
  try {
    const res = await axios.put(
      `https://invacbackend.onrender.com/movie/edit/${id}`,
      data
    );
  ...
  async (dispatch) => {
    ...
    try {
      const res = await axios.patch(
        `https://invacbackend.onrender.com/movie/${id}/review`,
        { reviews }
      );
...
export const deleteMovie = (id) => async (dispatch) => {
  try {
    let res = await axios.delete(
      `https://invacbackend.onrender.com/movie/delete/${id}`
    );
...
export const toggleWatchStatus = (id, watchStatus) => async (dispatch) => {
  try {
    const res = await axios.patch(
      `https://invacbackend.onrender.com/movie/${id}/watchStatus`,
      { watchStatus }
    );
...
export const getMovieById = (id) => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      `https://invacbackend.onrender.com/movie/${id}`
    );
